  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="text-lg mb-6">
        Welcome to Vasquez Law Firm's Cornelius Defensa Criminal office. We provide expert services
      ...
      <div className="space-y-4">
        ...
        <section>
          ...
          <p>
            Don't wait - reach out to our Cornelius Defensa Criminal office for immediate
            assistance.
          </p>
        </section>
      </div>
