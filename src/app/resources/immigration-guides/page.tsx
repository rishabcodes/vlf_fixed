    ...
    content: `
      <div className="prose prose-lg max-w-none">
        <div className="bg-blue-50 border-l-4 border-blue-500 p-6 mb-8">
          <h2 className="text-2xl font-bold text-blue-900 mb-4">📚 Your Complete Immigration Resource Center</h2>
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-6">Family-Based Immigration Guides</h2>
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-6">Employment-Based Immigration Guides</h2>
        ...
        <div className="bg-red-50 p-6 rounded-lg mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-red-100 p-4 rounded">
              <h4 className="font-bold mb-2">In Immigration Court</h4>
              <ul className="list-disc pl-5 space-y-1">
