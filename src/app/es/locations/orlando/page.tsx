...
export const metadata: Metadata = {
  title: 'Orlando Inmigración Abogados | Lesiones Personales Abogados - Vasquez Law Firm',
  description:
  ...
  openGraph: {
    title: 'Orlando Inmigración Abogados | Lesiones Personales Abogados - Vasquez Law Firm',
    description:
      'Orlando FL law office serving Orange County & Central Florida. Inmigración, personal injury, workers comp & criminal defense. Bilingual attorneys. 24/7 Emergency Services.',
  ...
  twitter: {
    ...
    title: 'Orlando Inmigración & Lesiones Personales Abogados - Vasquez Law Firm',
    description:
          ...
          __html: JSON.stringify([
            {
              ...
              alternateName: 'Orlando Inmigración & Lesiones Personales Abogados',
              description:
