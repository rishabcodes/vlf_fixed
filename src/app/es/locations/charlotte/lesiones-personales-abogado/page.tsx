...
export const metadata: Metadata = {
  title: 'Charlotte Lesiones Personales Abogado - Car Accidents & More | Vasquez Law',
  description:
  ...
  openGraph: {
    title: 'Charlotte Lesiones Personales Abogado - YO PELEO POR TI™ | Vasquez Law',
    description:
  ...
  twitter: {
    ...
    title: 'Charlotte Lesiones Personales Abogado - YO PELEO POR TI™',
...
export default function CharlottePersonalInjuryAbogadoPage() {
  const serviceLocationData = {
    cityName: 'Charlotte',
    serviceName: 'Lesiones Personales',
    heroTitle: 'Charlotte Lesiones Personales Abogado',
    ...
    serviceDetails: {
      title: 'Charlotte Lesiones Personales Legal Services',
      description:
    ...
    whyHireUs: {
      title: 'Why Hire a Charlotte Lesiones Personales Abogado?',
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: 'Vasquez Law Firm - Charlotte Lesiones Personales Abogado',
            description:
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                '@type': 'ListItem',
                position: 4,
                name: 'Lesiones Personales Abogado',
