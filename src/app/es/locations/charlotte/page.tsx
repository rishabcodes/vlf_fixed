...
export const metadata: Metadata = {
  title: 'Charlotte Inmigración Abogados | Lesiones Personales Abogados - Vasquez Law Firm',
  description:
  ...
  openGraph: {
    title: 'Charlotte Inmigración Abogados | Lesiones Personales Abogados - Vasquez Law Firm',
    description:
      'Charlotte NC law office serving Mecklenburg County. Inmigración, personal injury, workers comp & criminal defense. Bilingual attorneys. 24/7 Emergency Services.',
  ...
  twitter: {
    ...
    title: 'Charlotte Inmigración & Lesiones Personales Abogados - Vasquez Law Firm',
    description:
          ...
          __html: JSON.stringify([
            {
              ...
              alternateName: 'Charlotte Inmigración & Lesiones Personales Abogados',
              description:
