...
export const metadata: Metadata = {
  title: 'Winston-Salem Inmigración Abogados | Lesiones Personales Abogados - Vasquez Law Firm',
  description:
  ...
  openGraph: {
    title: 'Winston-Salem Inmigración Abogados | Lesiones Personales Abogados - Vasquez Law Firm',
    description:
      'Expert legal representation in Winston-Salem NC. Inmigración, personal injury, workers comp & criminal defense. Free consultation. Se habla español.',
