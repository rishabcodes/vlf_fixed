...
export const metadata: Metadata = {
  title: `Lesiones Personales - Kannapolis | Vasquez Law Firm`,
  description: `Lesiones Personales services in Kannapolis. Experienced attorneys serving the local community.`,
};

export default function KannapolisPersonalInjuryPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Lesiones Personales in Kannapolis</h1>
