...
export const metadata: Metadata = {
  title: `Lesiones Personales - Wilmington | Vasquez Law Firm`,
  description: `Lesiones Personales services in Wilmington. Experienced attorneys serving the local community.`,
};

export default function WilmingtonPersonalInjuryPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Lesiones Personales in Wilmington</h1>
