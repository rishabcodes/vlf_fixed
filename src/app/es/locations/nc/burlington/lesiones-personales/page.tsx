...
export const metadata: Metadata = {
  title: `Lesiones Personales - Burlington | Vasquez Law Firm`,
  description: `Lesiones Personales services in Burlington. Experienced attorneys serving the local community.`,
};

export default function BurlingtonPersonalInjuryPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Lesiones Personales in Burlington</h1>
