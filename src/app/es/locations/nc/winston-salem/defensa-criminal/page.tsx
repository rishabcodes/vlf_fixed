...
export const metadata: Metadata = {
  title: `Defensa Criminal - Winston Salem | Vasquez Law Firm`,
  description: `Defensa Criminal services in Winston Salem. Experienced attorneys serving the local community.`,
};

export default function WinstonSalemCriminalDefensePage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Defensa Criminal in Winston Salem</h1>
