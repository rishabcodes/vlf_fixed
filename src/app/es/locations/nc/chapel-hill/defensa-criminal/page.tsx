...
export const metadata: Metadata = {
  title: `Defensa Criminal - Chapel Hill | Vasquez Law Firm`,
  description: `Defensa Criminal services in Chapel Hill. Experienced attorneys serving the local community.`,
};

export default function ChapelHillCriminalDefensePage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Defensa Criminal in Chapel Hill</h1>
