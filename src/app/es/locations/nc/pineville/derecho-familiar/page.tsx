...
export const metadata: Metadata = {
  title: `Derecho Familiar - Pineville | Vasquez Law Firm`,
  description: `Derecho Familiar services in Pineville. Experienced attorneys serving the local community.`,
};

export default function PinevilleFamilyLawPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Derecho Familiar in Pineville</h1>
