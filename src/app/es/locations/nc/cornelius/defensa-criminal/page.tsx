...
export const metadata: Metadata = {
  title: `Defensa Criminal - Cornelius | Vasquez Law Firm`,
  description: `Defensa Criminal services in Cornelius. Experienced attorneys serving the local community.`,
};

export default function CorneliusCriminalDefensePage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Defensa Criminal in Cornelius</h1>
