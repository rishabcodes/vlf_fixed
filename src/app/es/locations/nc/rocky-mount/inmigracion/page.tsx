...
export const metadata: Metadata = {
  title: `Inmigración - Rocky Mount | Vasquez Law Firm`,
  description: `Inmigración services in Rocky Mount. Experienced attorneys serving the local community.`,
};

export default function RockyMountInmigraciónPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Inmigración in Rocky Mount</h1>
