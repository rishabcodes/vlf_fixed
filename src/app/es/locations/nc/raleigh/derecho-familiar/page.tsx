...
export const metadata: Metadata = {
  title: `Derecho Familiar - Raleigh | Vasquez Law Firm`,
  description: `Derecho Familiar services in Raleigh. Experienced attorneys serving the local community.`,
};

export default function RaleighFamilyLawPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Derecho Familiar in Raleigh</h1>
