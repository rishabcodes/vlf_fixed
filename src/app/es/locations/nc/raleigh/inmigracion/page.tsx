...
export const metadata: Metadata = {
  title: `Inmigración - Raleigh | Vasquez Law Firm`,
  description: `Inmigración services in Raleigh. Experienced attorneys serving the local community.`,
};

export default function RaleighInmigraciónPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Inmigración in Raleigh</h1>
