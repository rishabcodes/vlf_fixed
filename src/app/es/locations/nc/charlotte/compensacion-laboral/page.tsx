...
export const metadata: Metadata = {
  title: `Compensación Laboral - Charlotte | Vasquez Law Firm`,
  description: `Compensación Laboral services in Charlotte. Experienced attorneys serving the local community.`,
};

export default function CharlotteWorkersCompensationPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Compensación Laboral in Charlotte</h1>
