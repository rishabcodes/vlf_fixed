...
export const metadata: Metadata = {
  title: `Defensa Criminal - Charlotte | Vasquez Law Firm`,
  description: `Defensa Criminal services in Charlotte. Experienced attorneys serving the local community.`,
};

export default function CharlotteCriminalDefensePage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Defensa Criminal in Charlotte</h1>
