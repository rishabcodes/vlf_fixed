...
export const metadata: Metadata = {
  title: `Inmigración - Charlotte | Vasquez Law Firm`,
  description: `Inmigración services in Charlotte. Experienced attorneys serving the local community.`,
};

export default function CharlotteInmigraciónPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Inmigración in Charlotte</h1>
