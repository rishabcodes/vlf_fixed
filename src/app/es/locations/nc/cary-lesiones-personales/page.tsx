  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="text-lg mb-6">
        Welcome to Vasquez Law Firm's Cary Lesiones Personales office. We provide expert services to
        the local community.
      </p>
      <div className="space-y-4">
        ...
        <section>
          ...
          <p>
            Don't wait - reach out to our Cary Lesiones Personales office for immediate assistance.
          </p>
        </section>
      </div>
    </div>
