...
export const metadata: Metadata = {
  title: 'How Can Drug Charges Impact Inmigración Status? - Vasquez Law Firm, PLLC',
  description:
...
export default function HowCanDrugChargesImpactInmigraciónStatusPage() {
  // TODO: Extract content from original file and format properly
  const post = {
    id: 'how-can-drug-charges-impact-immigration-status',
    title: 'How Can Drug Charges Impact Inmigración Status?',
