...
export const metadata: Metadata = {
  title: 'Client Testimonios | Vasquez Law Firm - I FIGHT FOR YOU™',
  description:
    'Read what our clients say about us. Over 30,000 cases won. Inmigración, personal injury, and criminal defense attorneys.',
  alternates: {
