        ...
        <div className="prose prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Contacto us through our website or phone</li>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-primary">Abogado-Client Privilege</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-primary">Contacto Us</h2>
            <p className="mb-4">
