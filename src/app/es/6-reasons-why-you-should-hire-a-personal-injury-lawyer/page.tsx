...
export const metadata: Metadata = {
  title: '6 Reasons Why You Should Hire a Lesiones Personales Abogado - Vasquez Law Firm, PLLC',
  description:
...
export default function ReasonsWhyYouShouldHireAPersonalInjuryAbogadoPage() {
  // TODO: Extract content from original file and format properly
  const post = {
    id: '6-reasons-why-you-should-hire-a-personal-injury-lawyer',
    title: '6 Reasons Why You Should Hire a Lesiones Personales Abogado',
