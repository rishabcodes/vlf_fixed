...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Slip and Fall Abogado NC | Premises Liability Abogado',
    description:
  ...
  return (
    <>
      <ModernPracticeAreaTemplate
        title="North Carolina Slip & Fall Accident Abogados"
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-2">Call an Abogado</h3>
                    <p className="text-gray-300">
