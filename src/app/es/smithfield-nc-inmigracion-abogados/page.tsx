...
export const metadata: Metadata = {
  title: 'Smithfield, NC Inmigración Abogados - Vasquez Law Firm, PLLC',
  description:
...
export default function SmithfieldNcInmigraciónAbogadosPage() {
  // TODO: Extract content from original file and format properly
  const post = {
    id: 'smithfield-nc-immigration-lawyers',
    title: 'Smithfield, NC Inmigración Abogados',
