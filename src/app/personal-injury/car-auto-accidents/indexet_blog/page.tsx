...
export default function IndexetBlogPage() {
  const post = {
    ...
    slug: 'indexet_blog',
    excerpt: 'Experienced car accident lawyers serving Raleigh, NC. We fight for maximum compensation for your injuries, lost wages, and pain and suffering. Free consultation available.',
    content: `
      <div class="prose prose-lg max-w-none">
        <h2>Trusted Car Accident Attorneys in Raleigh, North Carolina</h2>
        ...
        <ol>
          ...
          <li><strong>Contact an Attorney:</strong> Before speaking with insurance companies, get legal advice</li>
        </ol>
        ...
        <h3>Contact Our Raleigh Car Accident Attorneys Today</h3>
    ...
    tags: ['car accidents', 'personal injury', 'raleigh', 'north carolina', 'auto accidents', 'compensation', 'legal help'],
  };
