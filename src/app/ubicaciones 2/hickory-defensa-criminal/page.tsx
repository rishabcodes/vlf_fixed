...
export const metadata = {
  title: 'Criminal Defense en Hickory, NC | Vasquez Law Firm',
  description:
    'Servicios legales de defensa criminal en Hickory, NC. Attorneys locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Criminal Defense en Hickory, NC',
      },
    ],
  },
  alternates: {
