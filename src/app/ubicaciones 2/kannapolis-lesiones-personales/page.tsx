...
export const metadata = {
  title: 'Personal Injury en Kannapolis, NC | Vasquez Law Firm',
  description:
    'Servicios legales de lesiones personales en Kannapolis, NC. Attorneys locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Personal Injury en Kannapolis, NC',
      },
    ],
  },
  alternates: {
