...
export const metadata = {
  title: 'Family Law en Mooresville, NC | Vasquez Law Firm',
  description:
    'Servicios legales de derecho familiar en Mooresville, NC. Attorneys locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Family Law en Mooresville, NC',
      },
    ],
  },
  alternates: {
