...
export const metadata = {
  title: 'Family Law en Wilmington, NC | Vasquez Law Firm',
  description:
    'Servicios legales de derecho familiar en Wilmington, NC. Attorneys locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Family Law en Wilmington, NC',
      },
    ],
  },
  alternates: {
