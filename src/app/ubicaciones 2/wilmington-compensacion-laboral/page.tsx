...
export const metadata = {
  title: 'Workers Compensation en Wilmington, NC | Vasquez Law Firm',
  description:
    'Servicios legales de compensación laboral en Wilmington, NC. Attorneys locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Workers Compensation en Wilmington, NC',
      },
    ],
  },
  alternates: {
