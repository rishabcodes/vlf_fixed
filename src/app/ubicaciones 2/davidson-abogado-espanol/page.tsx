...
export default function DavidsonAttorneyEspanolPage() {
...
export const metadata = {
  title: 'Attorney que Habla Español en Davidson, NC | Vasquez Law Firm',
  description:
    'Servicios legales de abogado que habla español en Davidson, NC. Attorneys locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Attorney que Habla Español en Davidson, NC',
      },
    ],
  },
  alternates: {
