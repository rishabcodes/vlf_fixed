...
export const metadata = {
  title: 'Family Law en Durham, NC | Vasquez Law Firm',
  description:
    'Servicios legales de derecho familiar en Durham, NC. Attorneys locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
