...
export const metadata = {
  title: 'Personal Injury en Durham, NC | Vasquez Law Firm',
  description:
    'Servicios legales de lesiones personales en Durham, NC. Attorneys locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Personal Injury en Durham, NC',
      },
    ],
  },
  alternates: {
