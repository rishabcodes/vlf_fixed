...
export const metadata = {
  title: 'Ley de Immigration en Fayetteville, NC | Vasquez Law Firm',
  description:
    'Servicios legales de ley de inmigración en Fayetteville, NC. Attorneys locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Ley de Immigration en Fayetteville, NC',
      },
    ],
  },
  alternates: {
