...
export const metadata: Metadata = {
  title: 'Ubicaciones - Bufete de Attorneys Vasquez | Servicios Legales en NC y FL',
  description:
  ...
  keywords:
    'Ubicaciones Bufete de Attorneys Vasquez, oficinas legales NC, oficinas legales FL, oficinas abogado de inmigración, ubicaciones abogado de lesiones personales, bufete bilingüe',
  openGraph: {
    title: 'Ubicaciones - Bufete de Attorneys Vasquez | Servicios Legales en NC y FL',
    description:
