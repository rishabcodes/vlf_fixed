...
export const metadata = {
  title: 'Workers Compensation en Wilson, NC | Vasquez Law Firm',
  description:
    'Servicios legales de compensación laboral en Wilson, NC. Attorneys locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Workers Compensation en Wilson, NC',
      },
    ],
  },
  alternates: {
