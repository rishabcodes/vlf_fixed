...
export const metadata = {
  title: 'Criminal Defense en Wilmington, NC | Vasquez Law Firm',
  description:
    'Servicios legales de defensa criminal en Wilmington, NC. Attorneys locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Criminal Defense en Wilmington, NC',
      },
    ],
  },
  alternates: {
