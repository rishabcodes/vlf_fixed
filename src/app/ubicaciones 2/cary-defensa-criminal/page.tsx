...
export const metadata = {
  title: 'Criminal Defense en Cary, NC | Vasquez Law Firm',
  description:
    'Servicios legales de defensa criminal en Cary, NC. Attorneys locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Criminal Defense en Cary, NC',
      },
    ],
  },
  alternates: {
