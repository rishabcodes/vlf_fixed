...
export default function HickoryAttorneyEspanolPage() {
...
export const metadata = {
  title: 'Attorney que Habla Español en Hickory, NC | Vasquez Law Firm',
  description:
    'Servicios legales de abogado que habla español en Hickory, NC. Attorneys locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Attorney que Habla Español en Hickory, NC',
      },
    ],
  },
  alternates: {
