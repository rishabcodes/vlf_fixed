...
export const metadata = {
  title: 'Workers Compensation en Davidson, NC | Vasquez Law Firm',
  description:
    'Servicios legales de compensación laboral en Davidson, NC. Attorneys locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Workers Compensation en Davidson, NC',
      },
    ],
  },
  alternates: {
