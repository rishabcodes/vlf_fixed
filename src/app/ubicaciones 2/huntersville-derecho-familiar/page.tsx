...
export const metadata = {
  title: 'Family Law en Huntersville, NC | Vasquez Law Firm',
  description:
    'Servicios legales de derecho familiar en Huntersville, NC. Attorneys locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Family Law en Huntersville, NC',
      },
    ],
  },
  alternates: {
