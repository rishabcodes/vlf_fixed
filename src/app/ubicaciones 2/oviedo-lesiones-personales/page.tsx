...
export const metadata = {
  title: 'Personal Injury en Oviedo, FL | Vasquez Law Firm',
  description:
    'Servicios legales de lesiones personales en Oviedo, FL. Attorneys locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Personal Injury en Oviedo, FL',
      },
    ],
  },
  alternates: {
