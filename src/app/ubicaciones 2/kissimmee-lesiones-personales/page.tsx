...
export const metadata = {
  title: 'Personal Injury en Kissimmee, FL | Vasquez Law Firm',
  description:
    'Servicios legales de lesiones personales en Kissimmee, FL. Attorneys locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Personal Injury en Kissimmee, FL',
      },
    ],
  },
  alternates: {
