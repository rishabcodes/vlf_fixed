...
export default function SanfordAttorneyEspanolPage() {
...
export const metadata = {
  title: 'Attorney que Habla Español en Sanford, FL | Vasquez Law Firm',
  description:
    'Servicios legales de abogado que habla español en Sanford, FL. Attorneys locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Attorney que Habla Español en Sanford, FL',
      },
    ],
  },
  alternates: {
