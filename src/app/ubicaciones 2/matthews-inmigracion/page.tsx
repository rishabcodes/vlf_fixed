...
export const metadata = {
  title: 'Ley de Immigration en Matthews, NC | Vasquez Law Firm',
  description:
    'Servicios legales de ley de inmigración en Matthews, NC. Attorneys locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Ley de Immigration en Matthews, NC',
      },
    ],
  },
  alternates: {
