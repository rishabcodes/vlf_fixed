...
export const metadata = {
  title: 'Ley de Immigration en Sanford, FL | Vasquez Law Firm',
  description:
    'Servicios legales de ley de inmigración en Sanford, FL. Attorneys locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Ley de Immigration en Sanford, FL',
      },
    ],
  },
  alternates: {
