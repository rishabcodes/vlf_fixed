...
export const metadata = {
  title: 'Personal Injury en Rocky Mount, NC | Vasquez Law Firm',
  description:
    'Servicios legales de lesiones personales en Rocky Mount, NC. Attorneys locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Personal Injury en Rocky Mount, NC',
      },
    ],
  },
  alternates: {
