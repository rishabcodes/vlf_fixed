...
export default function KissimmeeAttorneyEspanolPage() {
...
export const metadata = {
  title: 'Attorney que Habla Español en Kissimmee, FL | Vasquez Law Firm',
  description:
    'Servicios legales de abogado que habla español en Kissimmee, FL. Attorneys locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Attorney que Habla Español en Kissimmee, FL',
      },
    ],
  },
  alternates: {
