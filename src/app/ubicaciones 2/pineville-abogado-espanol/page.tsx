...
export default function PinevilleAttorneyEspanolPage() {
...
export const metadata = {
  title: 'Attorney que Habla Español en Pineville, NC | Vasquez Law Firm',
  description:
    'Servicios legales de abogado que habla español en Pineville, NC. Attorneys locales experimentados. Consultas gratuitas. Llame (704) 533-7000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Attorney que Habla Español en Pineville, NC',
      },
    ],
  },
  alternates: {
