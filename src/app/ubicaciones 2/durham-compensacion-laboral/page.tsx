...
export const metadata = {
  title: 'Workers Compensation en Durham, NC | Vasquez Law Firm',
  description:
    'Servicios legales de compensación laboral en Durham, NC. Attorneys locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Workers Compensation en Durham, NC',
      },
    ],
  },
  alternates: {
