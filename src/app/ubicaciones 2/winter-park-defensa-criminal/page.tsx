...
export const metadata = {
  title: 'Criminal Defense en Winter Park, FL | Vasquez Law Firm',
  description:
    'Servicios legales de defensa criminal en Winter Park, FL. Attorneys locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Criminal Defense en Winter Park, FL',
      },
    ],
  },
  alternates: {
