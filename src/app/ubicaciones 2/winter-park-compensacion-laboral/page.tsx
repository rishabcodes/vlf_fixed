...
export const metadata = {
  title: 'Workers Compensation en Winter Park, FL | Vasquez Law Firm',
  description:
    'Servicios legales de compensación laboral en Winter Park, FL. Attorneys locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Workers Compensation en Winter Park, FL',
      },
    ],
  },
  alternates: {
