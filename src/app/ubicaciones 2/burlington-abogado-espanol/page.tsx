...
export default function BurlingtonAttorneyEspanolPage() {
...
export const metadata = {
  title: 'Attorney que Habla Español en Burlington, NC | Vasquez Law Firm',
  description:
    'Servicios legales de abogado que habla español en Burlington, NC. Attorneys locales experimentados. Consultas gratuitas. Llame (919) 533-7000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Attorney que Habla Español en Burlington, NC',
      },
    ],
  },
  alternates: {
