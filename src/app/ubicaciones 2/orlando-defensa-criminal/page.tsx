...
export const metadata = {
  title: 'Criminal Defense en Orlando, FL | Vasquez Law Firm',
  description:
    'Servicios legales de defensa criminal en Orlando, FL. Attorneys locales experimentados. Consultas gratuitas. Llame (407) 955-5000.',
  keywords:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Criminal Defense en Orlando, FL',
      },
    ],
  },
  alternates: {
