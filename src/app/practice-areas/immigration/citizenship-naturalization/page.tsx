    ...
    <ModernPracticeAreaTemplate
      ...
      content={
        <div className="space-y-12">
          ...
          <section>
            <h2 className="text-3xl font-bold text-primary mb-8">Why Choose Vasquez Law for Citizenship</h2>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20 text-center">
                <h3 className="text-xl font-bold text-primary mb-2">Expert Preparation</h3>
                <div className="text-3xl font-bold text-white mb-2">100%</div>
                <p className="text-gray-300 text-sm">Complete application accuracy</p>
              </div>
              <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20 text-center">
                <h3 className="text-xl font-bold text-primary mb-2">Interview Success</h3>
                <div className="text-3xl font-bold text-white mb-2">98%</div>
                <p className="text-gray-300 text-sm">Pass rate with our preparation</p>
              </div>
              <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20 text-center">
                <h3 className="text-xl font-bold text-primary mb-2">Fast Processing</h3>
                <div className="text-3xl font-bold text-white mb-2">6-12</div>
                <p className="text-gray-300 text-sm">Months average timeline</p>
              </div>
            </div>
            <p className="text-center text-gray-400 mt-4 text-sm">
              Contact us to discuss your citizenship eligibility and begin your journey
            </p>
          </section>
        </div>
      }
