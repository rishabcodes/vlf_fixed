...
export default function AdjustmentOfStatusPage() {
  ...
  const content = {
    ...
    urgencyMessage: 'If your priority date is current, don\'t delay. The adjustment of status process has strict deadlines and requirements. Contact us immediately for urgent assistance.',
    ...
    <ModernPracticeAreaTemplate
      ...
      content={
        <div className="space-y-12">
          ...
          {/* Current Filing Fees */}
          <section>
            <h2 className="text-3xl font-bold text-primary mb-8">Government Filing Fees</h2>
            <div className="grid md:grid-cols-4 gap-6">
              <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20 text-center">
                ...
                <div className="text-2xl font-bold text-white mb-2">Government Fee</div>
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20 text-center">
                ...
                <div className="text-2xl font-bold text-white mb-2">Filing Fee</div>
            ...
            <p className="text-center text-gray-400 mt-4 text-sm">
              *Government filing fees apply. Fee waivers available for qualifying applicants.
            </p>
          </section>
        </div>
      }
