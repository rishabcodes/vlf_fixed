...
export default function CarAccidentsPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Case value depends on injury severity, medical costs, lost wages, pain and suffering, and other factors. We've recovered millions for car accident victims, with settlements ranging from modest amounts to substantial seven-figure recoveries."
    },
    {
  ...
  const content = {
    ...
    successStats: [
      ...
      { number: 'Millions', label: 'Total Recovered' },
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-primary/20">
                ...
                <div className="space-y-3">
                  ...
                  <ul className="text-gray-300 text-sm space-y-2">
                    <li>• Minimum bodily injury coverage per person</li>
                    <li>• Minimum bodily injury coverage per accident</li>
                    <li>• Minimum property damage coverage</li>
